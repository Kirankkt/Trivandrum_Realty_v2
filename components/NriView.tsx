    ...
    if (!result || !result.nriMetrics) {
        return (
            <div className="flex flex-col items-center justify-center h-96 bg-white rounded-xl shadow-sm border border-dashed border-gray-300">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">NRI Insights Unavailable</h3>
                <p className="text-gray-500 text-center max-w-md px-4">
                    This estimate was loaded from cache. NRI analysis (suitability score, airport distance, villa feasibility) is only available for newly generated estimates.<br />
                    <span className="text-sm text-gray-400 mt-2 block">Try searching a different locality for fresh insights.</span>
                </p>
            </div>
        );
    }
